...
;  Global Symbols
;-----------------------------------------------
export  PWM8_Vout_EnableInt
export _PWM8_Vout_EnableInt
export  PWM8_Vout_DisableInt
export _PWM8_Vout_DisableInt
export  PWM8_Vout_Start
export _PWM8_Vout_Start
export  PWM8_Vout_Stop
export _PWM8_Vout_Stop
export  PWM8_Vout_WritePeriod
export _PWM8_Vout_WritePeriod
export  PWM8_Vout_WritePulseWidth
export _PWM8_Vout_WritePulseWidth
export  PWM8_Vout_bReadPulseWidth
export _PWM8_Vout_bReadPulseWidth
export  PWM8_Vout_bReadCounter
export _PWM8_Vout_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM8_Vout_ReadPulseWidth    ; deprecated
export _bPWM8_Vout_ReadPulseWidth    ; deprecated
export  bPWM8_Vout_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_Vout_EnableInt
;
;  DESCRIPTION:
...
;
 PWM8_Vout_EnableInt:
_PWM8_Vout_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM8_Vout_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_Vout_DisableInt
;
;  DESCRIPTION:
...
_PWM8_Vout_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM8_Vout_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_Vout_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_Vout_WritePeriod:
_PWM8_Vout_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_Vout_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_Vout_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_Vout_WritePulseWidth:
_PWM8_Vout_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_Vout_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_Vout_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_Vout_bReadPulseWidth:
_PWM8_Vout_bReadPulseWidth:
 bPWM8_Vout_ReadPulseWidth:                      ; this name deprecated
_bPWM8_Vout_ReadPulseWidth:                      ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8_Vout_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_Vout_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWM8_Vout_bReadCounter:
_PWM8_Vout_bReadCounter:
 bPWM8_Vout_ReadCounter:                         ; this name deprecated
_bPWM8_Vout_ReadCounter:                         ; this name deprecated
   ...
   mov   A, reg[PWM8_Vout_COMPARE_REG]           ; Save the Compare register on the stack
   push  A                                       ;
   PWM8_Vout_Stop_M                              ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM8_Vout_INPUT_REG]             ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM8_Vout_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM8_Vout_COUNTER_REG]           ; DR2 <- DR0
   mov   A, reg[PWM8_Vout_COMPARE_REG]           ; Stash the Count on the stack
   ...
   mov   reg[PWM8_Vout_INPUT_REG], A             ;
   M8C_SetBank0                                  ;
   PWM8_Vout_Start_M                             ;   then re-enable the PWM.
