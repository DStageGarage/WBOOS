...
include "m8c.inc"
include "PWM8_NB_Out.inc"
include "memory.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  PWM8_NB_Out_EnableInt
export _PWM8_NB_Out_EnableInt
export  PWM8_NB_Out_DisableInt
export _PWM8_NB_Out_DisableInt
export  PWM8_NB_Out_Start
export _PWM8_NB_Out_Start
export  PWM8_NB_Out_Stop
export _PWM8_NB_Out_Stop
export  PWM8_NB_Out_WritePeriod
export _PWM8_NB_Out_WritePeriod
export  PWM8_NB_Out_WritePulseWidth
export _PWM8_NB_Out_WritePulseWidth
export  PWM8_NB_Out_bReadPulseWidth
export _PWM8_NB_Out_bReadPulseWidth
export  PWM8_NB_Out_bReadCounter
export _PWM8_NB_Out_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM8_NB_Out_ReadPulseWidth    ; deprecated
export _bPWM8_NB_Out_ReadPulseWidth    ; deprecated
export  bPWM8_NB_Out_ReadCounter       ; deprecated
export _bPWM8_NB_Out_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_NB_Out_EnableInt
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_NB_Out_EnableInt:
_PWM8_NB_Out_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM8_NB_Out_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_NB_Out_DisableInt
;
;  DESCRIPTION:
...
_PWM8_NB_Out_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM8_NB_Out_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_NB_Out_Start
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_NB_Out_Stop
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_NB_Out_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_NB_Out_WritePeriod:
_PWM8_NB_Out_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_NB_Out_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_NB_Out_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_NB_Out_WritePulseWidth:
_PWM8_NB_Out_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_NB_Out_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_NB_Out_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_NB_Out_bReadPulseWidth:
_PWM8_NB_Out_bReadPulseWidth:
 bPWM8_NB_Out_ReadPulseWidth:                    ; this name deprecated
_bPWM8_NB_Out_ReadPulseWidth:                    ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8_NB_Out_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_NB_Out_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWM8_NB_Out_bReadCounter:
_PWM8_NB_Out_bReadCounter:
 bPWM8_NB_Out_ReadCounter:                       ; this name deprecated
_bPWM8_NB_Out_ReadCounter:                       ; this name deprecated
   ...
   mov   A, reg[PWM8_NB_Out_COMPARE_REG]         ; Save the Compare register on the stack
   push  A                                       ;
   PWM8_NB_Out_Stop_M                            ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM8_NB_Out_INPUT_REG]           ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM8_NB_Out_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM8_NB_Out_COUNTER_REG]         ; DR2 <- DR0
   mov   A, reg[PWM8_NB_Out_COMPARE_REG]         ; Stash the Count on the stack
   ...
   mov   reg[PWM8_NB_Out_INPUT_REG], A           ;
   M8C_SetBank0                                  ;
   PWM8_NB_Out_Start_M                           ;   then re-enable the PWM.
