...
;  Global Symbols
;-----------------------------------------------
export  AMUX4_0_InputSelect
export _AMUX4_0_InputSelect

export  AMUX4_0_Start
export _AMUX4_0_Start

export  AMUX4_0_Stop
export _AMUX4_0_Stop
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: AMUX4_0_InputSelect
;
;  DESCRIPTION:
...
ENDIF
    and  A,~AMUX4_0_MUX_MASK           ; Mask off the bits for this Mux
