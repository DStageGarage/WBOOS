...
export  DAC6_VGND_Start
export _DAC6_VGND_Start
export  DAC6_VGND_SetPower
export _DAC6_VGND_SetPower

export  DAC6_VGND_WriteBlind
export _DAC6_VGND_WriteBlind
export  DAC6_VGND_WriteStall
export _DAC6_VGND_WriteStall

export  DAC6_VGND_Stop
export _DAC6_VGND_Stop
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DAC6_VGND_Start
;  FUNCTION NAME: DAC6_VGND_SetPower
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DAC6_VGND_WriteBlind
;
;  DESCRIPTION:
...
;    functions.
;
 DAC6_VGND_WriteBlind:
_DAC6_VGND_WriteBlind:

  RAM_PROLOGUE RAM_USE_CLASS_1 
  IF DAC6_VGND_OFFSETBINARY
  ...
  ENDIF
  IF DAC6_VGND_OFFSETBINARY | DAC6_VGND_TWOSCOMPLEMENT
...
BlindMagSet:
  ...
  ENDIF
    ...
    or   A, DAC6_VGND_CR0_HIBITS
    mov  reg[DAC6_VGND_CR0], A
    RAM_EPILOGUE RAM_USE_CLASS_1 
    ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DAC6_VGND_WriteStall
;
;  DESCRIPTION:
...
;
 ...
 DAC6_VGND_WriteStall:
_DAC6_VGND_WriteStall:
...
_DAC6_VGND_Stop:
    RAM_PROLOGUE RAM_USE_CLASS_1 
    and reg[DAC6_VGND_CR3], ~bPWRMASK
    RAM_EPILOGUE RAM_USE_CLASS_1 
    ret
.ENDSECTION

; End of File DAC6_VGND.asm
